# Day 22. NLP, tokenization과 입력 표현
...
| 용어 | 설명 |
| --- | --- |
| NLP | 오늘 코드에서 확인할 핵심 개념입니다. |
| token | 오늘 코드에서 확인할 핵심 개념입니다. |
| vocabulary | 오늘 코드에서 확인할 핵심 개념입니다. |
| token ID | 오늘 코드에서 확인할 핵심 개념입니다. |
| input_ids | 오늘 코드에서 확인할 핵심 개념입니다. |
| attention_mask | 오늘 코드에서 확인할 핵심 개념입니다. |
