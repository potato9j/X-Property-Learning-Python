...
| 용어 | 설명 |
| --- | --- |
| greedy | 오늘 코드에서 확인할 핵심 개념입니다. |
| sampling | 오늘 코드에서 확인할 핵심 개념입니다. |
| temperature | 오늘 코드에서 확인할 핵심 개념입니다. |
| top-k | 오늘 코드에서 확인할 핵심 개념입니다. |
| top-p | 오늘 코드에서 확인할 핵심 개념입니다. |
| RAG | 오늘 코드에서 확인할 핵심 개념입니다. |
| LoRA | 오늘 코드에서 확인할 핵심 개념입니다. |
