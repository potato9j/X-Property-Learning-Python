...
| 용어 | 설명 |
| --- | --- |
| tokenizer | 오늘 코드에서 확인할 핵심 개념입니다. |
| model card | 오늘 코드에서 확인할 핵심 개념입니다. |
| inference | 오늘 코드에서 확인할 핵심 개념입니다. |
| generation | 오늘 코드에서 확인할 핵심 개념입니다. |
| license | 오늘 코드에서 확인할 핵심 개념입니다. |
