...
| 용어 | 설명 |
| --- | --- |
| Q | 오늘 코드에서 확인할 핵심 개념입니다. |
| K | 오늘 코드에서 확인할 핵심 개념입니다. |
| V | 오늘 코드에서 확인할 핵심 개념입니다. |
| attention score | 오늘 코드에서 확인할 핵심 개념입니다. |
| causal mask | 오늘 코드에서 확인할 핵심 개념입니다. |
| multi-head | 오늘 코드에서 확인할 핵심 개념입니다. |
