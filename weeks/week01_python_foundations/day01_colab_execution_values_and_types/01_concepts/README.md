...
| 용어 | 설명 |
| --- | --- |
| Colab | 오늘 코드에서 확인할 핵심 개념입니다. |
| 표현식 | 오늘 코드에서 확인할 핵심 개념입니다. |
| 변수 | 오늘 코드에서 확인할 핵심 개념입니다. |
| int | 오늘 코드에서 확인할 핵심 개념입니다. |
| float | 오늘 코드에서 확인할 핵심 개념입니다. |
| str | 오늘 코드에서 확인할 핵심 개념입니다. |
| bool | 오늘 코드에서 확인할 핵심 개념입니다. |
| None | 오늘 코드에서 확인할 핵심 개념입니다. |
