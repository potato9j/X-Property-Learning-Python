...
| 용어 | 설명 |
| --- | --- |
| class | 오늘 코드에서 확인할 핵심 개념입니다. |
| object | 오늘 코드에서 확인할 핵심 개념입니다. |
| instance | 오늘 코드에서 확인할 핵심 개념입니다. |
| __init__ | 오늘 코드에서 확인할 핵심 개념입니다. |
| self | 오늘 코드에서 확인할 핵심 개념입니다. |
| 상속 | 오늘 코드에서 확인할 핵심 개념입니다. |
