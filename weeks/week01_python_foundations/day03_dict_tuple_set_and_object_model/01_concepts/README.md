...
| 용어 | 설명 |
| --- | --- |
| dictionary | 오늘 코드에서 확인할 핵심 개념입니다. |
| tuple | 오늘 코드에서 확인할 핵심 개념입니다. |
| set | 오늘 코드에서 확인할 핵심 개념입니다. |
| 객체 | 오늘 코드에서 확인할 핵심 개념입니다. |
| 메서드 | 오늘 코드에서 확인할 핵심 개념입니다. |
| 속성 | 오늘 코드에서 확인할 핵심 개념입니다. |

## 5. 예측하고 실행하기
```python
day = 3
topic = "dictionary, tuple, set과 객체 모델"
