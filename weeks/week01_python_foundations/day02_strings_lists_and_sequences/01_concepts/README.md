...
| 용어 | 설명 |
| --- | --- |
| 문자열 | 오늘 코드에서 확인할 핵심 개념입니다. |
| 리스트 | 오늘 코드에서 확인할 핵심 개념입니다. |
| 인덱싱 | 오늘 코드에서 확인할 핵심 개념입니다. |
| 슬라이싱 | 오늘 코드에서 확인할 핵심 개념입니다. |
| mutable | 오늘 코드에서 확인할 핵심 개념입니다. |
| immutable | 오늘 코드에서 확인할 핵심 개념입니다. |

## 5. 예측하고 실행하기
```python
day = 2
topic = "문자열, 리스트와 순서형 자료"
