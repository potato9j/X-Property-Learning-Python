...
| 용어 | 설명 |
| --- | --- |
| module | 오늘 코드에서 확인할 핵심 개념입니다. |
| package | 오늘 코드에서 확인할 핵심 개념입니다. |
| import | 오늘 코드에서 확인할 핵심 개념입니다. |
| 예외 | 오늘 코드에서 확인할 핵심 개념입니다. |
| pathlib | 오늘 코드에서 확인할 핵심 개념입니다. |
| CSV | 오늘 코드에서 확인할 핵심 개념입니다. |
| JSON | 오늘 코드에서 확인할 핵심 개념입니다. |

## 5. 예측하고 실행하기
```python
day = 6
topic = "module, 오류, 파일과 디버깅"
