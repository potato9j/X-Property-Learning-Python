...
| 용어 | 설명 |
| --- | --- |
| if | 오늘 코드에서 확인할 핵심 개념입니다. |
| for | 오늘 코드에서 확인할 핵심 개념입니다. |
| while | 오늘 코드에서 확인할 핵심 개념입니다. |
| range | 오늘 코드에서 확인할 핵심 개념입니다. |
| enumerate | 오늘 코드에서 확인할 핵심 개념입니다. |
| zip | 오늘 코드에서 확인할 핵심 개념입니다. |
| comprehension | 오늘 코드에서 확인할 핵심 개념입니다. |

## 5. 예측하고 실행하기
```python
day = 4
topic = "조건문, 반복문과 comprehension"
