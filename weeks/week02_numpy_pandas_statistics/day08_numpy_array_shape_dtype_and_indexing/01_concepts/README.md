...
| 용어 | 설명 |
| --- | --- |
| ndarray | 오늘 코드에서 확인할 핵심 개념입니다. |
| shape | 오늘 코드에서 확인할 핵심 개념입니다. |
| ndim | 오늘 코드에서 확인할 핵심 개념입니다. |
| dtype | 오늘 코드에서 확인할 핵심 개념입니다. |
| indexing | 오늘 코드에서 확인할 핵심 개념입니다. |
| masking | 오늘 코드에서 확인할 핵심 개념입니다. |
