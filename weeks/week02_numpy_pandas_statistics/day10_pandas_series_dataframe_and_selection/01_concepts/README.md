...
| 용어 | 설명 |
| --- | --- |
| Series | 오늘 코드에서 확인할 핵심 개념입니다. |
| DataFrame | 오늘 코드에서 확인할 핵심 개념입니다. |
| loc | 오늘 코드에서 확인할 핵심 개념입니다. |
| iloc | 오늘 코드에서 확인할 핵심 개념입니다. |
| filter | 오늘 코드에서 확인할 핵심 개념입니다. |
| sort | 오늘 코드에서 확인할 핵심 개념입니다. |
