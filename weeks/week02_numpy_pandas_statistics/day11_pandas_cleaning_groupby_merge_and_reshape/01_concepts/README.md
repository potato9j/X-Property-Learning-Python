...
| 용어 | 설명 |
| --- | --- |
| NaN | 오늘 코드에서 확인할 핵심 개념입니다. |
| dropna | 오늘 코드에서 확인할 핵심 개념입니다. |
| fillna | 오늘 코드에서 확인할 핵심 개념입니다. |
| groupby | 오늘 코드에서 확인할 핵심 개념입니다. |
| merge | 오늘 코드에서 확인할 핵심 개념입니다. |
| pivot_table | 오늘 코드에서 확인할 핵심 개념입니다. |
