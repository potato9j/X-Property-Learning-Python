...
| 용어 | 설명 |
| --- | --- |
| EDA | 오늘 코드에서 확인할 핵심 개념입니다. |
| histogram | 오늘 코드에서 확인할 핵심 개념입니다. |
| scatter | 오늘 코드에서 확인할 핵심 개념입니다. |
| box plot | 오늘 코드에서 확인할 핵심 개념입니다. |
| outlier | 오늘 코드에서 확인할 핵심 개념입니다. |
| interpretation | 오늘 코드에서 확인할 핵심 개념입니다. |
