...
| 용어 | 설명 |
| --- | --- |
| 모집단 | 오늘 코드에서 확인할 핵심 개념입니다. |
| 표본 | 오늘 코드에서 확인할 핵심 개념입니다. |
| 평균 | 오늘 코드에서 확인할 핵심 개념입니다. |
| 중앙값 | 오늘 코드에서 확인할 핵심 개념입니다. |
| 분산 | 오늘 코드에서 확인할 핵심 개념입니다. |
| 표준편차 | 오늘 코드에서 확인할 핵심 개념입니다. |
| IQR | 오늘 코드에서 확인할 핵심 개념입니다. |
