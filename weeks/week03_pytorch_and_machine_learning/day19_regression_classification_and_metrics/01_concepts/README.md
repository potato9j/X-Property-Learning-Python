...
| 용어 | 설명 |
| --- | --- |
| MSE | 오늘 코드에서 확인할 핵심 개념입니다. |
| BCE | 오늘 코드에서 확인할 핵심 개념입니다. |
| CrossEntropyLoss | 오늘 코드에서 확인할 핵심 개념입니다. |
| accuracy | 오늘 코드에서 확인할 핵심 개념입니다. |
| precision | 오늘 코드에서 확인할 핵심 개념입니다. |
| recall | 오늘 코드에서 확인할 핵심 개념입니다. |
| F1 | 오늘 코드에서 확인할 핵심 개념입니다. |
