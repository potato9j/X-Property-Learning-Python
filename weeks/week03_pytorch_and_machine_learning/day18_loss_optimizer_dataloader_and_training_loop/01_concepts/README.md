# Day 18. loss, optimizer, DataLoader와 학습 루프
...
| 용어 | 설명 |
| --- | --- |
| loss | 오늘 코드에서 확인할 핵심 개념입니다. |
| optimizer | 오늘 코드에서 확인할 핵심 개념입니다. |
| Dataset | 오늘 코드에서 확인할 핵심 개념입니다. |
| DataLoader | 오늘 코드에서 확인할 핵심 개념입니다. |
| epoch | 오늘 코드에서 확인할 핵심 개념입니다. |
| batch | 오늘 코드에서 확인할 핵심 개념입니다. |
