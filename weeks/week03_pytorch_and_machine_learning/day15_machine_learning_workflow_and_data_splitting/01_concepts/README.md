...
| 용어 | 설명 |
| --- | --- |
| feature | 오늘 코드에서 확인할 핵심 개념입니다. |
| label | 오늘 코드에서 확인할 핵심 개념입니다. |
| train | 오늘 코드에서 확인할 핵심 개념입니다. |
| validation | 오늘 코드에서 확인할 핵심 개념입니다. |
| test | 오늘 코드에서 확인할 핵심 개념입니다. |
| data leakage | 오늘 코드에서 확인할 핵심 개념입니다. |
